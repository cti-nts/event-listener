...
{
    public function testReturnedChannelsArrayShouldContainChannelNamesAsKeys(): void
    {
    ...
    public function testReturnedChannelsArrayShouldContainSecondPartAsFilterIfExists(): void
    {
        putenv('EVENT_CHANNELS=
            channel1;\Application\Messaging\Impl\ExampleFilter1;\Application\Messaging\Impl\ExampleTranslator1
            channel2
    ...
    public function testReturnedChannelsArrayShouldContainThirdPartAsTranslatorIfExists(): void
    {
        putenv('EVENT_CHANNELS=
            channel1;\Application\Messaging\Impl\ExampleFilter1;\Application\Messaging\Impl\ExampleTranslator1
            channel2
